...
def objective(trial):
    ...
    trainer = pl.Trainer(max_epochs=10, check_val_every_n_epoch=1, log_every_n_steps=1, deterministic=True,
                        )
...
"""
    [I 2023-12-25 10:54:36,847] Trial 0 finished with value: 2.0593302249908447 and parameters: {'weight_decay': 0.0008679303239891218, 'eps': 2.030846751774609e-06, 'rho': 0.45602624719978757, 'lr': 0.0035117806907654413, 'batch_size': 128}. Best is trial 0 with value: 2.0593302249908447.
Number of finished trials: 1
Best trial:
  Value: 2.0593302249908447
  Params: 
